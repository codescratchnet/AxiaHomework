...
{
    /// <summary>
    /// This controller will be used for Account Service
    /// </summary>
    [Authorize]
    public class AccountController : Controller
    {
        ...
        [SwaggerResponse(200, Type = typeof(LoginViewModel))]
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //Set the user role
                    UserRole selectedUserRole = (UserRole)Enum.Parse(typeof(UserRole), model.UsreRole);
                    var roles = new List<string> { selectedUserRole.ToString() };
